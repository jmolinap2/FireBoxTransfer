...
import 'package:fireboxtransfer_app/config/init_error.dart';
...
import 'package:fireboxtransfer_app/widget/watcher/life_cycle_watcher.dart';
import 'package:fireboxtransfer_app/widget/watcher/shortcut_watcher.dart';
import 'package:fireboxtransfer_app/widget/watcher/tray_watcher.dart';
  ...
  runApp(
    RefenaScope.withContainer(
      ...
      child: TranslationProvider(
        child: const FireBoxTransferApp(),
      ),
    ),
  );
}

class FireBoxTransferApp extends StatelessWidget {
  const FireBoxTransferApp();
