...
import 'package:fireboxtransfer_app/util/native/cmd_helper.dart';
import 'package:fireboxtransfer_app/util/native/macos_channel.dart' as macos_channel;
...
import 'package:fireboxtransfer_app/widget/dialogs/not_available_on_platform_dialog.dart';
            ...
            primaryButton: _FixButton(
              ...
              onTapMap: {
                TargetPlatform.windows: _CommandFixAction(
                  ...
                  commands: [
                    'netsh advfirewall firewall add rule name="FireBoxTransfer" dir=in action=allow protocol=TCP localport=${settings.port}',
                    'netsh advfirewall firewall add rule name="FireBoxTransfer" dir=in action=allow protocol=UDP localport=${settings.port}',
                  ],
                ),
              },
            ),
